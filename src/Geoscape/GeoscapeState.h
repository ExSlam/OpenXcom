...
private:
	...
	Globe *_globe;
	TextButton *_btnIntercept, *_btnBases, *_btnGraphs, *_btnUfopaedia, *_btnOptions, *_btnFunding, *_btnCustomUis;
...
public:
	...
	/// Handler for opening ruleset-provided custom interfaces.
